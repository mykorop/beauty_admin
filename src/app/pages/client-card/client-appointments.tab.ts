          ...
          @for (row of rows; track row.appointment.appointmentId) {
            ...
            >
              ...
              <td class="px-4 py-3 whitespace-nowrap">
                ...
                <p class="text-xs text-slate-500" data-testid="appointment-row-timezone">{{ row.timezone }}</p>
                @if (row.stale) {
            ...
            <tr>
              <td colspan="7" class="py-8 text-center text-slate-600" data-testid="appointments-empty">
